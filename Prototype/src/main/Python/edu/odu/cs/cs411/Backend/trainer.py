...
def process_musicXMLData(file_path):
    ...
    for note in score.flatten().notes:
        if note.isNote:
            scorestring = str(note.measureNumber)+ ", "+ str(note.pitch) + ", " + str(note.duration.type) + ", " + str(note.duration.quarterLength) + ", " + str(process_beams(note.beams))
            scorenote.append(scorestring)
        elif note.isChord:
            for x in note._notes:
                scorestring = str(x.measureNumber)+ ", "+ str(x.pitch) + ", " + str(x.duration.type) + ", " + str(x.duration.quarterLength) + ", " + str(process_beams(x.beams))
                scorenote.append(scorestring)
