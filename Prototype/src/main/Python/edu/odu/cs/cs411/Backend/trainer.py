...
# And Use The Evalution Model to predict Beam Errors From Uploaded MXL,XML,MusicXML 
# Files For the User to see.
#
#
# A Trainer Has:
#  Pre-Processing of Data - to be prepared to be used as inputs and labels and turned to tensors
#  DataSet Class - Access to Folders from training and testing folders and applys the transformations from raw data to tensors
...
#  Evalutation - Uses the model and tests it with the training dataset
