...
image_label.grid(row=0, column=1, pady=10, sticky="nsew")  # Span two rows for the image
...
label.grid(row=1, column=1, padx=10, pady=10)  # Increased columnspan to accommodate the Editor button
settings_button.grid(row=2, column=0, pady=10)
profile_button.grid(row=2, column=2, pady=10)
editor_button.grid(row=3, column=1, pady=10)  # Placed the Editor button in the third column
